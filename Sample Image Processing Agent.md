Конечно, давайте рассмотрим пример, который демонстрирует ключевые особенности артефактов и типичные сценарии их использования в Google ADK, используя выдуманный "Агент по обработке изображений".

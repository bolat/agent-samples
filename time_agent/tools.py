...
# agent imports
from time_agent.models import GetCurrentTimeInput, TimeResult, InvalidTimezoneError
...
# )
def get_current_time(timezone: str) -> dict:#TimeResult | InvalidTimezoneError:
    ...
    Returns:
        dict: A dictionary containing the current time information or an error message.
